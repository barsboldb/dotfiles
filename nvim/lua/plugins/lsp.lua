return {
  ...
  config = function()
    ...
    lspconfig('clangd', {
      ...
      init_options = { fallbackFlags = { '-xc', '-std=c11' } },
    })
    ...
    lspconfig('lua_ls', { filetypes = { 'lua' } })
    lspconfig('gopls', { filetypes = { 'go' } })
    ...
    require("clangd_extensions").setup({
      ast = {
        ...
        kind_icons = {
          ...
          PackExpansion = "", TemplateTypeParm = "", TemplateTemplateParm = "", TemplateParamObject = "",
        },
      },
    })
    ...
    vim.diagnostic.config({
      ...
      signs = {
        text = {
          ...
          [vim.diagnostic.severity.INFO]  = "כֿ",
        },
      },
    })

    vim.lsp.enable({
      'pyright', 'svelte', 'ts_ls', 'tinymist', 'emmet_language_server',
      'eslint', 'clangd', 'rust_analyzer', 'lua_ls', 'gopls', 'sourcekit', 'cssls',
    })
  end,
}
